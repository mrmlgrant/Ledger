...
PAGES.dashboard=m=>{
  ...
  m.insertAdjacentHTML('beforeend',`<div class="dash-stat-grid" style="margin-bottom:18px">
  ...
  // ── Tax summary row — 4 cards above the charts ──
  m.insertAdjacentHTML('beforeend',`<div class="grid4" style="margin-bottom:18px">
